...
let colorArray = ['##FF006A', '#379102', '#0376FC', '#FFA800', '#954DCE'];
let previousColor = '#FF006A';
let colorIndex = 0;
let typed = new Typed('#typed', {
  // Тут id того блока, в которм будет анимация
  stringsElement: '#typed-strings',
  // Тут id блока из которого берем строки для анимации
  typeSpeed: 100,
  // Скорость печати
  startDelay: 500,
  ...
  // Скорость удаления
  loop: true,
  // Указываем, повторять ли анимацию
  backDelay: 1000,
  preStringTyped: (pos, self) => {
    typedEl.style.color = previousColor;
    switch (pos) {
      case 0:
        typedEl.style.color = colorArray[0];
        break;
      case 1:
        typedEl.style.color = colorArray[1];
        break;
      case 2:
        typedEl.style.color = colorArray[2];
        break;
      case 3:
        typedEl.style.color = colorArray[3];
        break;
      case 4:
        typedEl.style.color = colorArray[4];
        break;
      default:
        colorIndex = 0;
        typedEl.style.color = colorArray[0];
...
const conactLink = document.querySelector('.mobile__link');
burger?.addEventListener('click', () => {
  body.classList.toggle('overflow');
  burger?.classList.toggle('burger--active');
  menuMobile?.classList.toggle('mobile-menu--visible');
});
links?.forEach(link => {
...
conactLink?.addEventListener('click', () => {
  body.classList.toggle('overflow');
  burger?.classList.toggle('burger--active');
  menuMobile?.classList.toggle('mobile-menu--visible');
});
...
const swiper = new swiper__WEBPACK_IMPORTED_MODULE_5__["default"]('.projects-mobile__swiper', {
  centeredSlides: true,
  spaceBetween: 12,
  slidesPerView: 1,
...
const SpecialistsSwiper = new swiper__WEBPACK_IMPORTED_MODULE_5__["default"]('.specialists__swiper', {
  slidesPerView: 'auto',
  spaceBetween: 20,
  loop: true,
  modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_6__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_6__.Pagination],
  breakpoints: {
    650: {
      ...
      spaceBetween: 12,
      navigation: {
        nextEl: '.specialists__button-next',
        prevEl: '.specialists__button-prev'
      }
    },
    769: {
      slidesPerView: 3
